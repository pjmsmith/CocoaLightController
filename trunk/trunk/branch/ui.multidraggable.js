...
$.widget("ui.multidraggable", $.extend({}, $.ui.draggable.prototype, {
	...
	mouseStart: function(event, draggedOptions) {
		...
		if (this.element.hasClass('selected') && o.isMain) {
	...
	_mouseStart: function(event) {
		...
		if (this.element.hasClass('selected')) {
			...
			$(".selected").multidraggable("mouseStart", event, o);
			return true;
		} else {
	...
	_mouseDrag: function(event, noPropagation) {
		if (this.element.hasClass('selected')) {
			$(".selected").multidraggable("mouseDrag", event, noPropagation);
			return false;
		} else {
	...
	_mouseStop: function(event) {
		if (this.element.hasClass('selected')) {
			$(".selected").multidraggable("mouseStop", event);
			return false;
		} else {
